...
if ( ! function_exists( 'dks_enqueue_assets' ) ) :
	...
	function dks_enqueue_assets() {
		...
		wp_enqueue_style(
			'dks-google-fonts',
			'https://fonts.googleapis.com/css2?family=Gabarito:wght@400;600;700;800;900&family=Montserrat:wght@400;500;700&display=swap',
			[],
			null
		);

		// ── Material Symbols (icon font used by theme + kolibri plugin) ────
		wp_enqueue_style(
			'dks-material-symbols',
